...
<html>
    ...
    <head>
        <link rel="stylesheet" href="res/css/condition-generale-dutilisation.css" />
        <?php
	...
	<body>
        ...
        <div class="corps">
	        ...
	        <div id="container">
	        	<h1>Conditions générales d'utilisation du site labeautedunet.fr</h1>
	            <p id="txt_derniere_modif">Dernière modification : 23/08/2018</p>
	            <h2>ARTICLE 1 : Objet</h2>

	                <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site labeautedunet et leur utilisation par «l'Utilisateur ».</p>
	                ...
	                labeautedunet se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>
	              
	            <h2>ARTICLE 2 : Mentions légales</h2>

	                <p>L’éditeur du site labeautedunet est Monsieur Béghin Clément.</p>
	                <p>Le Directeur de la publication est Monsieur Béghin Clément.</p>
	                <p>L'hébergeur du site labeautedunet est la Société 1&1 INTERNET SARL au capital de 100 000,00 € dont le siège social est situé au 7 pl de la gare 57200 Sarreguemines.</p>

	            <h2>ARTICLE 3 : Définitions</h2>

	                <p>La présente clause a pour objet de définir les différents termes essentiels du contrat :</p>
	                <p class="tabulation">•   Utilisateur : ce terme désigne toute personne qui utilise le site ou l'un des services proposés par le site.</p>
	                <p class="tabulation">•   Contenu utilisateur : ce sont les données transmises par l'Utilisateur au sein du site.</p>
	                <p class="tabulation">•   Membre : l'Utilisateur devient membre lorsqu'il est identifié sur le site.</p>
	                <p class="tabulation">•   Identifiant et mot de passe : c'est l'ensemble des informations nécessaires à l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est confidentiel.</p>

	            <h2>ARTICLE 4 : Accès aux services</h2>

	                <p>Le site permet à l'Utilisateur un accès gratuit aux services suivants :</p>
	                <p class="tabulation">    •   Visionnage des vidéos  ;</p>
	                <p class="tabulation">    •   Visionnage des images  ;</p>
	                ...
	                <p>    Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de labeautedunet.</p>
	                ...
	                <p>    L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse contact@labeautedunet.fr. </p>

	            <h2>ARTICLE 5 : Propriété intellectuelle</h2>

	                <p>Les marques, logos, signes et tout autre contenu du site (en excluant les vidéos) font l'objet d'une protection par le Code de la propriété intellectuelle et plus particulièrement par le droit d'auteur.</p>
	            ...
	            <h2>ARTICLE 6 : Données personnelles</h2>
	                ...
	                <p>En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. </p><p>L'Utilisateur exerce ce droit via :</p>
	                <p class="tabulation">•   son espace personnel ;</p>
	                <p class="tabulation" >•   <a href="contact.php">un formulaire de contact</a> ;</p>
	                <p class="tabulation">•   par mail à contact@labeautedunet.fr;</p>

	            <h2 id="cookies">ARTICLE 7 : Cookies</h2>

	            	<p>Pour offrir à l'Utilisateur une expérience optimale le site a besoin d'utiliser des cookies.</p>
	            	<p>Les cookies utilisés servent à :</p>
	            	<p class="tabulation">•   améliorer le confort du Membre grâce à l'option "Se souvenir de moi" ou lors de la connexion via Facebook ;</p>
	            	<p class="tabulation">•   établir des statistiques d’utilisation des services. Ces statistiques sont effectuées par le service <a href="https://privacy.google.com/businesses/" target="_blank">Analytics de Google</a> ;</p>
	            	<p>Pour toute autre informations sur les cookies ou pour savoir comment les désactiver vous pouvez vous rendre à <a href="https://cookiesandyou.com/" target="_blank">cette adresse.</a></p>
	            ...
	            <h2>ARTICLE 9 : Liens hypertextes</h2>
	                ...
	                <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de labeautedunet qui n'a pas le contrôle de ces liens.</p>
	            ...
	            <h2>ARTICLE 10 : Évolution du contrat</h2>
